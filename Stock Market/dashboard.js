...
function plotStock(stockId, stockName, stockSymbol, open, high, low, volume){
    ...
    $('#dStockOpen').html('$ '+parseInt(open).toFixed(2));
    $('#dStockLow').html('$ '+parseInt(low).toFixed(2));
    $('#dStockHigh').html('$ '+parseInt(high).toFixed(2));
